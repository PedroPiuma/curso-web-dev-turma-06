...
// function livrosMaisVendido(X, livros) {
//     let result = ''
//     for (let i = 0; i < livros.length; i++) {
//         let MaisVendidos
//         if (livros[i].quantidadeVendido > MaisVendidos || i === 0) {
//             MaisVendidos += livros[i].nome
//         }
...
//     return result
// }
// console.log(livrosMaisVendido(10, livros))

function ordernadorDeLivrosEmVendas(livros) {
    let aux
    for (let i = 0; i < livros.length; i++) {
...
ordernadorDeLivrosEmVendas(livros)

function topLivros(X, livros) {
    for (let i = 0; i < X - 1; i++) {
